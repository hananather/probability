# Plan: 4.0 - Descriptive Statistics Hub

## Standardized Hub Implementation

**Follow the exact pattern from Chapter 6 & 7 hubs:**
1. Use the shared `ChapterHub` component
2. Optional opening animation (like Chapter 6's coin flip)
3. Key Concepts Card with LaTeX
4. Introduction Card explaining the chapter
5. Section configuration with standardized structure
6. Clean, minimal implementation

## Component File
`/src/components/04-descriptive-statistics-sampling/4-0-DescriptiveStatisticsHub.jsx`
...
1. **Standardized Structure**
   - Uses shared `ChapterHub` component (like Ch6 & Ch7)
   - Key Concepts Card with LaTeX formulas
   - Population-to-Distribution animation (reused from existing component)
   - Introduction Card explaining the chapter
   - Section configuration array with all metadata

2. **Clean Implementation**
   - Reuses existing `SamplingAnimation` component
   - No custom state management (handled by ChapterHub)
   - Routes follow pattern: `/chapter4/[section-name]`
   - Uses existing UI components

3. **Section Configuration**
   - 5 sections matching course structure
   - Progressive difficulty: Beginner → Intermediate → Advanced
   - Clear prerequisites between sections
   - Engaging questions for each section
   - Time estimates based on component count

## Notes

- Includes the existing Population-to-Distribution animation from SamplingDistributionsHub
- Animation shows sampling process: Population → Sample → Distribution
- Purple color scheme for statistics theme  
- All 28 components distributed across 5 sections
- Progress tracking handled automatically by ChapterHub component