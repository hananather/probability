...
const QuickReferenceTab = dynamic(() => 
  Promise.resolve(() => {
    ...
    const DistributionsQuickReference = () => {
    ...
    return DistributionsQuickReference;
  }),
  { ssr: false }
);
