...
const FoundationsTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/02-probability-dictionary/Tab1FoundationsTab'), { ssr: false }
);
const WorkedExamplesTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/02-probability-dictionary/Tab2WorkedExamplesTab'), { ssr: false }
);
const QuickReferenceTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/02-probability-dictionary/Tab3QuickReferenceTab'), { ssr: false }
);

// Interactive tab
const InteractiveTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/02-probability-dictionary/Tab4InteractiveTab'), { ssr: false }
);
