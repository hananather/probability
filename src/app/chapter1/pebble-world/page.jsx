...
const FoundationsTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-1-2-pebble-world/Tab1FoundationsTab'), { ssr: false }
);
const WorkedExamplesTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-1-2-pebble-world/Tab2WorkedExamplesTab'), { ssr: false }
);
const QuickReferenceTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-1-2-pebble-world/Tab3QuickReferenceTab'), { ssr: false }
);

// Interactive tab
const InteractiveTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-1-2-pebble-world/Tab4InteractiveTab'), { ssr: false }
);
