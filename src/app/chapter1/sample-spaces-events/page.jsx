...
const FoundationsTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/sample-spaces-events/FoundationsTab'),
  { ssr: false }
);

const WorkedExamplesTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/sample-spaces-events/WorkedExamplesTab'),
  { ssr: false }
);

const QuickReferenceTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/sample-spaces-events/QuickReferenceTab'),
  { ssr: false }
);
