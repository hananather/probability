...
const FoundationsTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-4-1-unordered-samples/Tab1FoundationsTab'), 
  { ssr: false }
);
const WorkedExamplesTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-4-1-unordered-samples/Tab2WorkedExamplesTab'), 
  { ssr: false }
);
const QuickReferenceTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-4-1-unordered-samples/Tab3QuickReferenceTab'), 
  { ssr: false }
);

// Import original component from its ORIGINAL location (unchanged)
const UnorderedSamples = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-4-1-UnorderedSamples'), 
  { ssr: false }
);
