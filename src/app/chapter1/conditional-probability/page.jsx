...
const FoundationsTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-6-1-conditional-probability/Tab1FoundationsTab'), 
  { ssr: false }
);
const WorkedExamplesTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-6-1-conditional-probability/Tab2WorkedExamplesTab'), 
  { ssr: false }
);
const QuickReferenceTab = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-6-1-conditional-probability/Tab3QuickReferenceTab'), 
  { ssr: false }
);

// Import original component from its ORIGINAL location (unchanged)
const ConditionalProbability = dynamic(() => 
  import('@/components/01-introduction-to-probabilities/1-6-1-ConditionalProbability'), 
  { ssr: false }
);
