...
import { BarChart, ChevronDown, ChevronUp, Sparkles } from 'lucide-react';
import { useMathJax } from '@/hooks/useMathJax';

const Chapter4FormulaHub = () => {
  const [expandedSections, setExpandedSections] = useState({
    centralLimitTheorem: true
  });
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-400 max-w-2xl mx-auto">
            Master the fundamental formulas of descriptive statistics and sampling by building them step-by-step.
          </p>
        </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-neutral-400 mt-1">
                    Learn the foundation of sampling distributions
                  </p>
                </div>
              </div>
