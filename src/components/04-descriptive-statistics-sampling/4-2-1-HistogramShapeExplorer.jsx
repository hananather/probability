  ...
  return (
    ...
    >
      ...
      <div className="mb-8 p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20 rounded-lg border border-blue-600/30">
        <h2 className="text-xl font-semibold mb-3 text-blue-400">Welcome to Histogram Mastery!</h2>
        <p className="text-gray-300 mb-4">
          Histograms are essential tools for visualizing continuous data. They help us see patterns, 
          identify outliers, and understand distributions. This learning journey will take you from 
          the basics to advanced shape recognition.
        </p>
