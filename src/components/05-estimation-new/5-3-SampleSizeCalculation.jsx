...
const SampleSizeCalculator = () => {
  ...
  useEffect(() => {
    ...
    gradient.append("stop")
      .attr("offset", "0%")
      .attr("stop-color", chapterColors.accent.green);
    
    gradient.append("stop")
      .attr("offset", "100%")
      .attr("stop-color", chapterColors.accent.red);
...
const SampleSizeLaboratory = () => {
  ...
  useEffect(() => {
    ...
    const planes = [
      ...
      { angle: 120, color: chapterColors.accent.blue, label: "Precision" },
      { angle: 240, color: chapterColors.accent.yellow, label: "Cost" }
    ];
