...
export default function DistributionSimulationFixed() {
      ...
      description={
        <>
          <p className={typography.description}>
            Explore how probability distributions affect expected value and variance. 
            Drag the bars to adjust probabilities and see how the statistics change.
          </p>
          <p className={cn(typography.description, "mt-2")}>
            The expected value represents the long-run average, while variance measures 
            the spread of outcomes around that average.
          </p>
        </>
      }
    >
