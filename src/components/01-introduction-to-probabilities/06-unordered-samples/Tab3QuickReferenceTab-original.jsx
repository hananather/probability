...
export default function QuickReferenceTab({ onComplete }) {
  ...
  useEffect(() => {
    if (isActive && inputRef.current && !showResult) {
      inputRef.current.focus();
    }
  }, [currentProblem, isActive, showResult]);
  ...
  },
  {
    ...
    content: ({ sectionIndex, isCompleted }) => (
      <SectionContent>
        <div className="space-y-4">
          <h4 className="font-semibold text-red-400 text-lg mb-4">Avoid These Errors</h4>
      ...
      <SectionContent>
        <div className="text-center mb-6">
          ...
          <p className="text-neutral-400">
            Content will be populated dynamically in the sectionsWithState mapping below
          </p>
        </div>
      </SectionContent>
    )
  ...
  // Update the speed practice section to use the state
                    ...
                    <div className="bg-neutral-900 p-6 rounded-lg">
                      ...
                      <div className="flex gap-2 items-center justify-center">
                        <input
                          ...
                          className="w-32 px-3 py-2 text-lg text-center bg-neutral-800 border border-neutral-600 rounded focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white"
                          placeholder="Answer"
                          disabled={showResult}
                          autoFocus
                          inputMode="numeric"
