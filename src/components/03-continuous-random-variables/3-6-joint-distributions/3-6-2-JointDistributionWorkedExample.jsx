    ...
    },
    {
      ...
      problem: (
        <div>
          ...
          <LaTeXFormula 
            formula={`f_{X,Y}(x,y) = 24xy \\text{ for } 0 \\leq x \\leq 1, 0 \\leq y \\leq 1-x`} 
            isBlock={true}
          />
      ...
      solution: (
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            <LaTeXFormula 
              formula={`= \\frac{7.2}{1.764} \\left[\\frac{y^2}{2}\\right]_{0.5}^{0.7} = \\frac{7.2}{1.764} \\cdot \\frac{0.49 - 0.25}{2} = 0.490`} 
              isBlock={true}
            />
          </div>
        </div>
