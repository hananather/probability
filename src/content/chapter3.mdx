...
import BridgeToContinuous from '../components/03-continuous-random-variables/BridgeToContinuousClient';
import ContinuousDistributionsPDF from '../components/03-continuous-random-variables/ContinuousDistributionsPDFClient';
import { IntegralWorkedExample } from '../components/03-continuous-random-variables/IntegralWorkedExample';
import NormalZScoreExplorer from '../components/03-continuous-random-variables/NormalZScoreExplorerClient';
import { NormalZScoreWorkedExample } from '../components/03-continuous-random-variables/NormalZScoreWorkedExample';
import EmpiricalRule from '../components/03-continuous-random-variables/EmpiricalRuleClient';
import ProcessCapability from '../components/03-continuous-random-variables/ProcessCapabilityClient';
import ZScorePracticeProblems from '../components/03-continuous-random-variables/ZScorePracticeProblemsClient';
import ZTableLookup from '../components/03-continuous-random-variables/ZTableLookupRedesignedClient';
import ExponentialDistribution from '../components/03-continuous-random-variables/ExponentialDistributionClient';
import { ExponentialDistributionWorkedExample } from '../components/03-continuous-random-variables/ExponentialDistributionWorkedExample';
import GammaDistribution from '../components/03-continuous-random-variables/GammaDistributionClient';
import { GammaDistributionWorkedExample } from '../components/03-continuous-random-variables/GammaDistributionWorkedExample';
import NormalApproxBinomial from '../components/03-continuous-random-variables/NormalApproxBinomialClient';
import { NormalApproxBinomialWorkedExample } from '../components/03-continuous-random-variables/NormalApproxBinomialWorkedExample';
import ContinuousExpectationVariance from '../components/03-continuous-random-variables/ContinuousExpectationVarianceClient';
...
<ConceptSection
  title="Normal Distribution & Z-Score Explorer (Original)"
  description={
    <>
      <p>
...
<ConceptSection
  title="Normal Z-Score Worked Examples"
  description={
    <>
      <p>
...
<ConceptSection
  title="Empirical Rule (68-95-99.7 Rule)"
  description={
    <>
      <p>
...
<ConceptSection
  title="Exponential Distribution Worked Examples"
  description={
    <>
      <p>
...
<ConceptSection
  title="Gamma Distribution Worked Examples"
  description={
    <>
      <p>
...
<ConceptSection
  title="Normal Approximation Worked Examples"
  description={
    <>
      <p>
