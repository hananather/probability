...
import NormalZScoreExplorer from '../components/03-continuous-random-variables/NormalZScoreExplorer';
import { NormalZScoreWorkedExample } from '../components/03-continuous-random-variables/NormalZScoreWorkedExample';
import EmpiricalRule from '../components/03-continuous-random-variables/EmpiricalRule';
import ProcessCapability from '../components/03-continuous-random-variables/ProcessCapability';
import ZScorePracticeProblems from '../components/03-continuous-random-variables/ZScorePracticeProblems';
import ZTableLookup from '../components/03-continuous-random-variables/ZTableLookup';
import { ExponentialDistribution } from '../components/03-continuous-random-variables/ExponentialDistribution';
...
import { GammaDistribution } from '../components/03-continuous-random-variables/GammaDistribution';
import { GammaDistributionWorkedExample } from '../components/03-continuous-random-variables/GammaDistributionWorkedExample';
import { NormalApproxBinomial } from '../components/03-continuous-random-variables/NormalApproxBinomial';
...
<ConceptSection
  ...
  description={
    <>
      <p>
        This section's components are currently being refactored for better educational value.
      </p>
    </>
  }
>
