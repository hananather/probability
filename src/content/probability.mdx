...
import CoinFlipSimulation from '../components/shared/CoinFlipSimulation.jsx';
import ExpectationVariance from '../components/02-discrete-random-variables/2-2-1-ExpectationVariance.jsx';
import CLTSimulation from '../components/shared/CLTSimulation.jsx';
// These components were removed during the Chapter 5 reorganization
// import PointEstimation from '../components/05-estimation/5-1-statistical-inference/5-1-4-PointEstimation.jsx'
// import ConfidenceInterval from '../components/05-estimation/5-0-1-GeneralConfidenceInterval.jsx'
// import Bootstrapping from '../components/05-estimation/5-4-ci-unknown-variance/5-4-3-Bootstrapping.jsx'
import ContinuousDistributionsPDF from '../components/03-continuous-random-variables/3-1-1-ContinuousDistributionsPDF.jsx';
import OptimizedImage from '../components/shared/OptimizedImage.jsx';

<div style={{ textAlign: 'center', marginTop: '2rem' }}>
  <OptimizedImage src="/uo.png" alt="University of Ottawa logo" width={75} height={75} />
  <h1>MAT 2377</h1>
...
<ConceptSection title="Point Estimation">
  {/* <PointEstimation /> - Component removed during Chapter 5 reorganization */}
</ConceptSection>

<h2 id="confidence-interval">Confidence Interval</h2>

<ConceptSection title="Confidence Interval">
  {/* <ConfidenceInterval /> - Component removed during Chapter 5 reorganization */}
</ConceptSection>

<h2 id="bootstrapping">Bootstrapping</h2>

<ConceptSection title="Bootstrapping">
  {/* <Bootstrapping /> - Component removed during Chapter 5 reorganization */}
</ConceptSection>
...
<ConceptSection 
  ...
  description={
    <>
      ...
      <p>
        As the equation indicates, the <em>posterior</em> probability of having the disease given that the test was positive depends on the <em>prior</em> probability of the disease P(Disease). Think of this as the incidence of the disease in the general population.
      </p>
    </>
  }
>
