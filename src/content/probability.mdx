...
import PointEstimation from '../components/05-estimation/5-1-4-PointEstimation.jsx'
import ConfidenceInterval from '../components/05-estimation/5-0-1-GeneralConfidenceInterval.jsx'
import Bootstrapping from '../components/05-estimation/5-4-3-Bootstrapping.jsx'
