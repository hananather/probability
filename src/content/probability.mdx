...
import PointEstimation from '../components/05-estimation/5-2-1-PointEstimation.jsx'
import ConfidenceInterval from '../components/05-estimation/5-3-1-ConfidenceInterval.jsx'
import Bootstrapping from '../components/05-estimation/5-4-1-Bootstrapping.jsx'
