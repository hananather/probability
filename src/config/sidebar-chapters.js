...
export const chapters = [
  ...
  },
  {
    ...
    path: '/chapter1',
    sections: [
      { title: '1.1 Foundation', url: '/chapter1/pebble-world' },
      { title: '1.2 English-to-Math Translation', url: '/chapter1/probability-dictionary' },
      { title: '1.3 Sample Spaces & Set Operations', url: '/chapter1/sample-spaces-events' },
      { title: '1.4 Counting Techniques', url: '/chapter1/counting-techniques' },
      { title: '1.5 Ordered Samples', url: '/chapter1/ordered-samples' },
      { title: '1.6 Unordered Samples', url: '/chapter1/unordered-samples' },
      { title: '1.7 Probability of an Event', url: '/chapter1/probability-event' },
      { title: '1.8 Conditional Probability', url: '/chapter1/conditional-probability' },
      { title: '1.9 Bayes\' Theorem', url: '/chapter1/bayes-theorem-visualizer' },
      { title: '1.10 Probabilistic Fallacies', url: '/chapter1/probabilistic-fallacies' },
      { title: '1.11 Monty Hall Masterclass', url: '/chapter1/monty-hall-masterclass' },
    ]
  },
  {
