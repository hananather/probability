...
import MontyHallIntro from './1-7-1-MontyHallIntro';
import MontyHallInteractive from './1-7-2-MontyHallGame';
import MontyHallBayesian from './1-7-3-MontyHallBayesProof';
import MontyHallSimulation from './1-7-4-MontyHallSimulation';
