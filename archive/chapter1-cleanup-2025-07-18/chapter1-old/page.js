...
const SampleSpacesEvents = lazy(() => 
  import('../../components/01-introduction-to-probabilities/03-sample-spaces-events')
    .catch(() => {
      return { default: () => <div className="text-red-500">Failed to load component</div> };
    })
);
const CountingTechniques = lazy(() => 
  import('../../components/01-introduction-to-probabilities/04-counting-techniques')
    .catch(() => {
      return { default: () => <div className="text-red-500">Failed to load component</div> };
    })
);
...
const ProbabilityEvent = lazy(() => 
  import('../../components/01-introduction-to-probabilities/07-probability-event')
    .catch(() => {
      return { default: () => <div className="text-red-500">Failed to load component</div> };
    })
);
...
const MontyHallJourney = lazy(() => 
  import('../../components/01-introduction-to-probabilities/11-monty-hall-masterclass')
    .catch(() => {
      return { default: () => <div className="text-red-500">Failed to load component</div> };
    })
);
const ProbabilisticFallacies = lazy(() => 
  import('../../components/01-introduction-to-probabilities/10-probabilistic-fallacies')
    .catch(() => {
      return { default: () => <div className="text-red-500">Failed to load component</div> };
    })
);
